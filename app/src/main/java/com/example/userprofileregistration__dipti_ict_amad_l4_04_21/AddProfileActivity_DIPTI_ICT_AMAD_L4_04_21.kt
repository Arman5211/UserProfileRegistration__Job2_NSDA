...
class AddProfileActivity_DIPTI_ICT_AMAD_L4_04_21 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_add_profile_dipti_ict_amad_l4_04_21)
        ...
        findViewById<Button>(R.id.addBtn).setOnClickListener {
            if (validateInputs(nameEditText, emailEditText, dobEditText, districtEditText, mobileEditText)) {
                ...
                val userProfile = UserProfile_DIPTI_ICT_AMAD_L4_04_21(name = name, email = email, dob = dob, district = district, mobile = mobile)
